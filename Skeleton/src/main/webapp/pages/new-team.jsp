...
<h1>Sign Up! Immediately!</h1>


<form:form method="post" modelAttribute="signupTeam" action="createTeam" id="signupTeam" cssClass="form-horizontal"  autocomplete="off">
    <fieldset>
        <legend>Enter A Fancy Teamname</legend>
